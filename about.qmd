---
title: ""
description: "About Innovative Assessment Solutions—a Kansas assessment company building the Astra through-year assessment system with Kansas districts."
---
...
<section class="page-header">
  <div class="page-header-text">
    <div class="page-header-inner">
      ...
      <p class="page-header-sub">A small assessment company building assessments that teachers can actually use.</p>
    </div>
  </div>
      ...
      <div>
        <div class="team-card">
          ...
          <div class="team-card-body">
            ...
            <p class="team-role">Director of Assessment and Research</p>
            <p>
